...
namespace NewsParser.Models.Responses.Publico;
...
public class NewsPublico
{
    ...
    [JsonPropertyName("multimediaPrincipal")]
    ...
    [JsonPropertyName("numeroComentarios")]
    ...
    [JsonPropertyName("hasManualSubtitle")]
    ...
    [JsonPropertyName("userLibraryStatus")]
...
public class Autore
{
    ...
    [JsonPropertyName("profissaoNaAltura")]
    public string ProfissaoNaAltura { get; set; }
...
public class Tag
{
    ...
    [JsonPropertyName("forcaConteudoAberto")]
